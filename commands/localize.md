...
Invoke the `doc-smith:doc-smith-localize` skill to execute document translation tasks.
...
Immediately invoke the `doc-smith:doc-smith-localize` skill to begin document translation.
